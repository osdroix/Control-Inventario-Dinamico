...
btnCerrarPopups.addEventListener('click', function(es){
	es.preventDefault();
...
btnCerrarPopup8.addEventListener('click', function(e8){
	e8.preventDefault();
...
btnCerrarPopup9.addEventListener('click', function(e9){
	e9.preventDefault();
...
btnCerrarPopup10.addEventListener('click', function(e10){
	e10.preventDefault();
...
btnCerrarPopup11.addEventListener('click', function(e11){
	e11.preventDefault();
...
btnCerrarPopup12.addEventListener('click', function(e12){
	e12.preventDefault();
...
btnCerrarPopup13.addEventListener('click', function(e13){
	e13.preventDefault();
...
btnCerrarPopup14.addEventListener('click', function(e14){
	e14.preventDefault();
...
btnCerrarPopup15.addEventListener('click', function(e15){
	e15.preventDefault();
...
btnCerrarPopup16.addEventListener('click', function(e16){
	e16.preventDefault();
...
btnCerrarPopup17.addEventListener('click', function(e17){
	e17.preventDefault();
...
btnCerrarPopup18.addEventListener('click', function(e18){
	e18.preventDefault();
...
btnCerrarPopup19.addEventListener('click', function(e19){
	e19.preventDefault();
...
btnCerrarPopup20.addEventListener('click', function(e20){
	e20.preventDefault();
...
btnCerrarPopup21.addEventListener('click', function(e21){
	e21.preventDefault();
...
btnCerrarPopup22.addEventListener('click', function(e22){
	e22.preventDefault();
...
btnCerrarPopup23.addEventListener('click', function(e23){
	e23.preventDefault();
...
btnCerrarPopup24.addEventListener('click', function(e24){
	e24.preventDefault();
